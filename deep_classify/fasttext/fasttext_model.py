...
#####################################################
#
# Filename      : fasttext_model.py
#
# Author        : JiangTingyu - Jiangty08@gmail.com
# Description   : ---
# Create        : 2017-07-24 10:31:19
# coding=utf-8
#####################################################
...
class fastText:
    def __init__(self, label_size, learning_rate, batch_size, decay_steps, decay_rate, num_sampled)
    self.label_size = label_size


    def inference(self):
        """
        input: [batch_size, sentence_len]
        embed: [vocab_size, embed_size]
        embed_output: [batch_size, sentence_len, embed_size]
        average: [batch_size, embed_size]
        output_params: w [embed_size, label_size], b [label_size]
